...
export default function RulesPage() {
  const { rules, logAction, addRule, updateRule, deleteRule } = useTrackerStore();
                ...
                {isEditing && (
                  <div style={{ 
                    ...
                    <button
                      ...
                      style={{ background: 'rgba(10,132,255,0.15)', border: 'none', borderRadius: '10px', padding: '8px', cursor: 'pointer', display: 'flex', alignItems: 'center' }}
                    >
                    ...
                    {deleteConfirm === rule.id ? (
                      <button
                        ...
                        style={{ background: 'var(--error-color)', border: 'none', borderRadius: '10px', padding: '8px 12px', cursor: 'pointer', color: 'white', fontSize: '0.75rem', fontWeight: 'bold' }}
                      >
                        Confirm
                      </button>
                    ) : (
                      <button
                        ...
                        style={{ background: 'rgba(255,59,48,0.15)', border: 'none', borderRadius: '10px', padding: '8px', cursor: 'pointer', display: 'flex', alignItems: 'center' }}
                      >
