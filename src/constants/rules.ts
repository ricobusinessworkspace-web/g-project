...
export const CODE_OF_HONOR: Rule[] = [
  ...
  // MANDATORY
  { id: 'ma_1', name: '100 Pushups/Situps/Run', category: 'MANDATORY', impact_type: 'POINTS', base_value: -1, iconName: 'Activity' },
  { id: 'ma_2', name: 'Social Post', category: 'MANDATORY', impact_type: 'POINTS', base_value: -2, iconName: 'Camera', daily_max: 1 },
  { id: 'ma_3', name: 'Chess', category: 'MANDATORY', impact_type: 'POINTS', base_value: -1, iconName: 'Gamepad2', daily_max: 1 },
  ...
  // SALES
  { id: 'sa_1', name: '10€ Revenue', category: 'SALES', impact_type: 'POINTS', base_value: -1, iconName: 'Banknote', requires_input: true, input_step: 10 },
  { id: 'sa_2', name: 'First Pitch / 20 CC', category: 'SALES', impact_type: 'POINTS', base_value: -2, iconName: 'PhoneCall' },

  // ABBAUEN
  { id: 'ab_1', name: '500 Pushups', category: 'ABBAUEN', impact_type: 'DEBT', base_value: -5, iconName: 'Dumbbell' },
  { id: 'ab_2', name: '10km Run', category: 'ABBAUEN', impact_type: 'DEBT', base_value: -10, iconName: 'Footprints' },
  { id: 'ab_3', name: 'Schulden bezahlen (5-10)', category: 'ABBAUEN', impact_type: 'POINTS', base_value: -1, iconName: 'Banknote', requires_input: true, input_step: 1 }, // Note: Handled specially in app to subtract both debt and points
];
